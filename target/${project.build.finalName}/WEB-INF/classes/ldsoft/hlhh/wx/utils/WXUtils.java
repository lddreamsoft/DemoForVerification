...
public class WXUtils {
	...
	public static WXMenu initMenu() {
		...
		wxViewButton.setUrl(getWXPageCodeUrl("http://i1f6318385.imwork.net/hlhh/wx/activities/luckyShake",
				"snsapi_base", "fromWX"));
		...
		wxMenu.setButton(new WXButton[] { wxClickButton, wxViewButton, wxButton });
